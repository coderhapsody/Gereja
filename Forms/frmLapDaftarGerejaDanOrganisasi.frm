VERSION 5.00
Begin VB.Form frmLapDaftarGerejaDanOrganisasi 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Daftar Gereja dan Organisasi Kristen Lainnya"
   ClientHeight    =   945
   ClientLeft      =   1650
   ClientTop       =   1935
   ClientWidth     =   4680
   Icon            =   "frmLapDaftarGerejaDanOrganisasi.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmLapDaftarGerejaDanOrganisasi"
...
Private Function DataIsValid() As Boolean
    ...
    sReportFileName = App.Path & "\Reports\DaftarGerejaDanOrganisasi.rpt"
